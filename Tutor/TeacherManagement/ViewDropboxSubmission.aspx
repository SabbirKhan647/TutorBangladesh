...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="menubar1">
        <div class="menupublic1">
            <ul id="navmenu1">
                <li><a id="A1" href="~/TeacherManagement/ViewDropboxSubmission.aspx" runat="server">Grade Submitted Assignment</a></li>
                <li><a id="A2" href="~/TeacherManagement/NewAssignment.aspx" runat="server">New Assignment</a></li>
            </ul>
        </div>
    </div>
    <br />
    <h3 class="pageHeading">Grade Submitted Assignment</h3>
    <br />
    <table>
        <tr>
            <td>
            ...
            <td>
                <asp:DropDownList ID="drBatch" runat="server"></asp:DropDownList></td>
            <td>
                <asp:Button ID="DisplayAssignments" runat="server" Text="Get Assignments" OnClick="DisplayAssignments_Click" /></td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label4" runat="server" Text="Assignments: "></asp:Label></td>
            <td>
                <asp:DropDownList ID="drAssignments" runat="server"></asp:DropDownList></td>
            <td>
                <asp:Label ID="lblWorth" runat="server" Text="Total Marks"></asp:Label></td>
            <td>
                <asp:Label ID="lblHoldsMarks" runat="server" Font-Bold="true"></asp:Label></td>
            <td>
                <asp:Button ID="btnDisplaySubmission" runat="server" Text="Show Submission" OnClick="btnDisplaySubmission_Click" />
                ...
                <div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td width="200px">
                                <asp:Label ID="Label1" runat="server" Text='<%#Eval("StudentName") %>' /></td>
                            <td width="300px">
                                <asp:Label ID="Label3" runat="server" Text='<%#Eval("DateSubmitted") %>' /></td>
                            <td width="400px">
                            ...
                            <td width="200px">
                                <asp:TextBox ID="txtassgnmtMarks" runat="server" Width="30px"></asp:TextBox>
