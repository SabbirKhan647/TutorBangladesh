...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        ...
        <asp:Label ID="lbltotalQues1" runat ="server" Font-Bold="true" Width="500px" ></asp:Label><br />
       
        <asp:Label ID="lblTotalMarks1" runat ="server" Font-Bold="true" Width="500px"   ></asp:Label>
        </div>
           <div class="">
 ...
 <%--  <asp:TextBox runat ="server" ID="txtQorder" Text='<%# Eval("QuestionOrder") %>' ></asp:TextBox>--%>
  ...
  <asp:Label runat ="server" ID="lblWOrth" Font-Bold="true" Text='<%# Eval("Worth") %>' CssClass ="quesWorth"></asp:Label>
