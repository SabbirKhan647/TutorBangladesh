...
{
    /// <summary>
    /// Summary description for RetrieveAssignmentDoc1
    /// </summary>
    public class RetrieveAssignmentDoc1 : IHttpHandler
    {
        ...
        private Stream ShowAssignmentDoc(int assignmentid)
        {
            ...
            string sql = "SELECT AssignmentData FROM Assignment WHERE AssignmentID = @assignmentid";
